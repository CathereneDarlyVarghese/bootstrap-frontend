    ...
    return (
        <div className="p-2 mb-16">
            <div className="flex flex-col items-center">
                <h1 className="font-sans font-semibold my-5 text-black text-2xl">Link QR</h1>
                {message && (
                    <div className="border rounded-2xl w-1/2 lg:w-2/3 md:w-fit border-slate-400 p-8">
                        <div >
                            <div className="flex flex-row justify-center">
                                <h1 className="font-sans">This QR is not linked with any asset</h1>
                            </div>
                            <div className="flex flex-row gap-5 mt-5 justify-center">
                                <button className="btn btn-sm bg-blue-900 hover:bg-blue-900" onClick={() => { setMessage(false) }}>Link Now</button>
                                <button className="btn btn-sm bg-blue-900 hover:bg-blue-900" onClick={() => navigate("/scan")}>Cancel
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                !message && (
                    <div >
                        ...
                        <div className="flex flex-col items-center w-3/4 sm:w-full justify-center mx-auto">
                            ...
                            <div
                                className={`flex flex-row gap-5 w-3/4 justify-center mt-5 ${filtersOpen ? "hidden" : ""
                                    }`}
                            >
                                <select
                                    name=""
            ...
            <ConfirmModal selectedAssetName={selectedAsset} open={modalOpen} setOpen={() => setModalOpen(false)} />
        </div>
    )
}
